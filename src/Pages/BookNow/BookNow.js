...
const BookNow = ({ modalData, setModalVisibility }) => {
  const bookingHandler = (e) => {
    ...
    fetch('https://assignment-12-server-side-eta.vercel.app/booking', {
      method: 'POST',
      headers: {
            ...
            <div className="lg:flex justify-between">
              <div className="w-1/2 p-4">
                ...
                <div className="form-group my-3">
                  <label className="block mb-2 text-sm">User Email:</label>
                  <input
                    type="email"
                    name="email"
                    disabled
                ...
                <div className="form-group my-3">
                  <label className="block mb-2 text-sm">Product Price:</label>
                  <input
                    type="text"
                    name="price"
                    disabled
                ...
                <div className="form-group my-3">
                  <label className="block mb-2 text-sm">Seller Email:</label>
                  <input
                    type="text"
                    name="selleremail"
                    disabled
              ...
              <div className="w-1/2 p-4">
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    required
                    className="input input-bordered input-primary w-full"
                    placeholder="Put your Mobile Number Here"
                  />
                </div>
                <div className="form-group my-3">
