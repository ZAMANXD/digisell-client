...
const AddProductForm = () => {
  ...
  return (
    <div className="py-10 lg:w-5/6 w-full mx-auto">
      {isUploading && <div className="isUploading">Uploading...</div>}
      <h3 className="text-center text-2xl font-bold">Add Product</h3>

      <form
        onSubmit={handleSubmit(onSubmit)}
        className="mt-5 lg:w-1/2 w-full mx-auto"
      >
        ...
        <div className="input-field my-3">
          ...
          {errors.name && (
            <p className="text-error my-3 text-left">
        ...
        <div className="input-field my-3">
          ...
          <input
            ...
            name="img"
            className="input my-3 px-0 h-full w-full"
          />
        ...
        <div className="input-field my-3">
          ...
          {errors.price && (
            <p className="text-error my-3 text-left">
              Re-Sell Price is required
            </p>
          )}
        </div>

        <div className="input-field my-3">
          <label className="mb-3 block">Select Product Category</label>
          <select
        ...
        <div className="input-field my-3">
          <label className="mb-3 block">Select Product Condition</label>
          <select
        ...
        <div className="input-field my-3">
          ...
          {errors.location && (
            <p className="text-error my-3 text-left">Location is required</p>
          )}
        </div>
        ...
        <div className="input-field my-3">
          ...
          {errors.description && (
            <p className="text-error my-3 text-left">Description is required</p>
          )}
        </div>
